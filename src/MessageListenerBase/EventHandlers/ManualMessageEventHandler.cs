...
{
    public class ManualMessageEventHandler :  IEventHandler<SQSEvent>
    {
        ...
        public ManualMessageEventHandler(IAmazonSQS sqsClient,
        ...
        public async Task HandleAsync(SQSEvent input, ILambdaContext context)
        {
            ...
            var message = JsonConvert.DeserializeObject<ManualSqsQueueUrlMessage>(input.Records[0].Body);
